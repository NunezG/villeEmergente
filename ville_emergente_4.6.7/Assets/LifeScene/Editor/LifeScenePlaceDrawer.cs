...
[CustomPropertyDrawer(typeof(LifeScenePlace))]
public class LifeScenePlaceDrawer : PropertyDrawer  {
	...
	public override void OnGUI (Rect position, SerializedProperty property, GUIContent label) 
	{
		...
		{
			LifeScenePlace lsp = property.objectReferenceValue as LifeScenePlace;
			int roleSelected = -1;
